    ...
    xl:mb-[30px]'>
      <div className='container mx-auto'>
        ...
        mb-4 xl:mb-0'>
          ...
          {/* category nav mobile*/}
          <div className={`${catNavMobile ? 'left-0' : '-left-full'} fixed top-0
          ...
          <Link to={'/'}>
            <div className='uppercase'>
              <h6 className=' text-accent borde font-bold'>
                <span className='text-white border border-accent font-extrabold'>2img</span>store
              </h6>
            </div>
          </Link>
          {/* search from - show only on desktop */}
          ...
          <div className='flex items-center gap-x-[10px]'>
            {/* phone */}
            <div className='hidden xl:flex uppercase'><Menu /></div>
            {/* cart icon*/}
            <div
              ...
              rounded-full top-3 -right-1 text-[13ppx] flex justify-center
